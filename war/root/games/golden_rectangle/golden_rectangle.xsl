...
<xsl:template name="cell" match="state/fact">
  ...
  <center>
  <xsl:if test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='r']"> <img class="piece" src="&ROOT;/resources/images/discs/red.png"/> </xsl:if>
  <xsl:if test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='y']"> <img class="piece" src="&ROOT;/resources/images/discs/yellow.png"/> </xsl:if>
  </center>
...
<xsl:template name="board_row">
  ...
  <xsl:call-template name="cell">
    <xsl:with-param name="row" select="8 - $row"/>
