...
<xsl:template name="cell" match="state/fact">
  ...
  <xsl:if test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='zombie']">Z</xsl:if>
  <xsl:if test="//fact[relation='cell' and argument[1]=$col and argument[2]=$row and argument[3]='hero']"><font color="#999999">H</font></xsl:if>
