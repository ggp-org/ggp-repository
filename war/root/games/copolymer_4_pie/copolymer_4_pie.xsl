...
<xsl:template name="main" match="/">
  <div>
    ...
    <xsl:variable name="p1"><xsl:value-of select="//fact[relation='isColor' and argument[1]='player1']/argument[2]"/></xsl:variable>
    <xsl:variable name="p2"><xsl:value-of select="//fact[relation='isColor' and argument[1]='player2']/argument[2]"/></xsl:variable>

    <div class="hex-row">
      <div class="{$p1}  hex     "><div class="left"></div><div class="middle"><p>P1</p></div><div class="right"></div></div>
      ...
      <div class="       hex     "><div class="left"></div><div class="middle"><p>  </p></div><div class="right"></div></div>
      <div class="       hex even"><div class="left"></div><div class="middle"><p>  </p></div><div class="right"></div></div>
      <div class="{$p2}  hex     "><div class="left"></div><div class="middle"><p>P2</p></div><div class="right"></div></div>
    </div>
    <div class="hex-row">
      <div class="       hex     "><div class="left"></div><div class="middle"><p>  </p></div><div class="right"></div></div>
