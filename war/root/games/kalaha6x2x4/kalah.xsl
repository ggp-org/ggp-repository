  ...
  <div>
    ...
    <style type="text/css" media="all">
      ...
      table.board td
      {
        ...
        border: 1px solid black;
        overflow: hidden;
        width:  <xsl:value-of select="$width * 0.11"/>px;
    ...
    <tbody>
      <tr>
        ...
        <td><xsl:value-of select="substring(//fact[relation='pit' and argument[1]='p12']/argument[2], 2)"/></td>
        <td><xsl:value-of select="substring(//fact[relation='pit' and argument[1]='p11']/argument[2], 2)"/></td>
